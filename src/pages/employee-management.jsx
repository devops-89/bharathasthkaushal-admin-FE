...
const ArtisanManagement = () => {
  ...
  const handleAddEmployee = async () => {
    try {
      ...
      if (response.status === 200) {
        alert("Employee registered successfully! Login credentials sent to email.");
        setPartnersData((prev) => [
          ...prev,
          { ...payload, id: prev.length + 1, joinedDate: new Date().toISOString().split("T")[0] }
        ]);
  ...
  const filteredPartners = partnersData.filter(partner => {
    ...
    const matchesLocation = !locationFilter || partner.location.toLowerCase().includes(locationFilter.toLowerCase())
          ...
          <div className="bg-white rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900">Register New Employee</h2>
                <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{selectedPartner.countryCode} {selectedPartner.phoneNo}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-medium">{selectedPartner.latitude}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">Longitude</p>
                      <p className="font-medium">{selectedPartner.longitude}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredPartners.map((partner) => (
                <tr key={partner.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{partner.countryCode} {partner.phoneNo}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
